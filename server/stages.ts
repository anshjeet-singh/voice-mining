...
export const STAGES: Record<string, StageDef> = {
  ...
  skool: {
    ...
    docs: () => [
      ...
      { docType: "skool_paid_community", filename: "02_paid_community.md", title: "Paid Community", description: "The PAID Skool community setup, SAME section structure and SAME copy-craft bar as the free community doc (3-word SEO names, benefit-selling emoji tagline with 'Join below' last line, two alive ~1000-char About pages with a hard hook headline / owner line near top / green-tick free-value / GIFT-BOX bonuses / one-sentence FOR and NOT-FOR / command-close CTA, a reference-grade VSL script, categories as names only with genuinely-distinct extras, 9 identical gamification levels, plugins + the 3 Title-Case links, two energetic pinned posts, Start Here, setup checklist), except this community SELLS the exact paid offer (name, price, promise, guarantee) from the approved Offers document, never a variant: the About page carries the paid value/price and the CTA points to the paid join/checkout, and the paid VSL justifies the price against the value and guarantee. The 9 GAMIFICATION LEVEL NAMES MUST BE IDENTICAL to the free community's. Use [COMMUNITY NAME] as the placeholder" },
    ],
    extraInstructions: () =>
      "TWO rules, both hard, and they do not conflict. RULE 1, cut the NOISE: zero meta-commentary, no rationale paragraphs, no 'why this works' / 'higher-converting format' / 'next actions' notes, no pipeline/foundation/behavioral-science/content-strategy sections, no audit sections. If a line is not copy that goes live in Skool, delete it. RULE 2, keep the LIFE: the actual Skool copy must be vibrant, colorful, high-energy, benefit-driven, gamified, and follow the skool-community-builder skill's proven frameworks and its About-page + VSL swipe files IN FULL. Read those swipe files before writing; model the winning opening moves, the value/bonus framing, and the command closes. Dry, flat, stripped copy is a FAIL. Build BOTH communities. GAMIFICATION LEVEL NAMES ARE IDENTICAL across free and paid. Both About-page VSL scripts are word-for-word ~3 minutes (420-480 words) at reference-VSL quality. Green ticks (✅) only on the free-value list; the GIFT-BOX emoji (🎁) on every bonus line. Ground the owner line, pains, and proof in the onboarding material and research verbatims, real proof only. [COMMUNITY NAME] stays a literal capitalized placeholder. No em dashes anywhere.",
  },
