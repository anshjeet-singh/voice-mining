...
export const STAGES: Record<string, StageDef> = {
  ...
  ads: {
    ...
    docs: () => [
      ...
      { docType: "ad_campaign_plan", filename: "04_campaign_plan.md", title: "Campaign Plan", description: "The Forester content-ad architecture from the haynes-scaling-systems framework sized to THIS client: content inventory audit into Cycle Bin 1 (pure views) and Cycle Bin 2 (strategic, no CTAs), 3-second exclusion setup, retention window from the client's sales cycle, budget split table, naming conventions, plus the DR campaign structure the 10 scripts feed into, and a compliance pre-flight per meta-ad-restrictions-prep for this niche" },
    ],
    extraInstructions: (ft) =>
